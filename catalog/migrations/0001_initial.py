# Generated by Django 2.2.1 on 2019-06-29 23:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Enter a brief description about the book', max_length=1000)),
                ...
                ('genre', models.CharField(help_text='Select a genre of this book', max_length=13, verbose_name='ISBN')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter the book genre (e.g. Horror, History)', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('imprint', models.DateField(blank=True, null=True)),
